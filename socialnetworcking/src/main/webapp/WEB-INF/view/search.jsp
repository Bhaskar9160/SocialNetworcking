...
<body>
	...
	<div class="sidebar">
		...
		<ul class="nav-links">
			...
			<li><a href="fav"> <i class="fa fa-bar-chart"
					aria-hidden="true"></i> <span class="link_name">FavoriteStation</span>
			</a></li>
	...
	<table   width="1005">
		<tr>
            ...
            <input name="source" type="text" placeholder="Source" required="" id="w-input-search1"  width="100%"/>
          </div>
          <div class="form-group">
            <input name="dest" id="w-input-search2"  type="text" placeholder="Destination" required="" />
          </div>
